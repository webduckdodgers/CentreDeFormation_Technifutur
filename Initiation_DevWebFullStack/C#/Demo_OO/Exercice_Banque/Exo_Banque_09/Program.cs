...
//1.Ajouter une méthode qui traitera l’événement « PassageEnNegatifAction » en affichant dans a console « Le compte {Numero} vient de passer en négatif ».
#endregion

// TESTS 
using Exo_Banque_09.Classes;
using Exo_Banque_09.Exceptions;
using Exo_Banque_09.Interfaces;
